<template>
  <div>
    ...
    >
      ...
      <p class="inline-block ml-2">Tambah Product OUT</p>
    </button>
    <div
      v-if="showModal"
    ...
    >
      ...
      <div class="mx-auto">
        <div class="w-full max-w-xs mx-auto mt-8">
          <form
            @submit.prevent="addProductsOut"
            class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"
          >
            <h1 class="text-gray-700 font-bold mt-4 mb-8 text-xl">Product OUT</h1>
            <div class="relative">
...
export default {
    ...
    methods: {
        ...mapActions(["addProductOut", "getProductOut"]),
        toggleModal() {
