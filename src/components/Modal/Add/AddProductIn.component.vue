<template>
  <div>
    ...
    >
      ...
      <p class="inline-block ml-2">Tambah Product IN</p>
    </button>
    <div
      v-if="showModal"
    ...
    >
      ...
      <div class="mx-auto">
        <div class="w-full max-w-xs mx-auto mt-8">
          <form
            @submit.prevent="addProductsIn"
            class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"
          >
            <h1 class="text-gray-700 font-bold mt-4 mb-8 text-xl">Product IN</h1>
            <div class="relative">
                ...
                >
                    <option
                      ...
                      :key="idx" :value="product.Product.id"
                    >
                      {{ product.Product.id }}
                    </option>
                </select>
            ...
            <div class="mt-6">
              ...
              <button
                class="text-blue-500 text-center font-bold mt-2"
                style="transition: all .15s ease"
                @click="toggleModal()"
              >Batal</button>
            </div>
...
export default {
    ...
    methods: {
        ...mapActions(["addProductIn", "getProductIn"]),
        toggleModal() {
